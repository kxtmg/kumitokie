import scheduleInfo from './scheduleInfo.json' with {type: 'json'};
...
function createScheduleElement(info) {
    ...
    <div class="scheduleLayout" style="padding: 0px 40px 40px 40px; gap: 20px;">
        <div class="dateContainer">
            <img src="./public/assets/singleFlower.svg" style="height: 25px; position: absolute;">
            <h2 class="numericDate">${info.dateNumber}</h2>
        </div>
        <img class= "diamondDivider" src="./public/assets/diamondDivider.svg">
        <div class="scheduleLayout" style="flex-grow: 1;">
            <img class="borderLeft" src="./public/assets/borderLeft.svg">
            <div class="midBorder">
                <p class="weekday">${info.dateWeekday}</p>
                <img class="flowerLeft" src="./public/assets/flowerDivider.svg">
                <p class="gameContent">${info.gameTitle}</p>
                <img class="flowerRight" src="./public/assets/flowerDivider.svg" >
            ...
            <img class="borderRight" src="./public/assets/borderRight.svg">
        </div>
    </div>
    `);
